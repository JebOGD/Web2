...
const SingleUserPage = () => {
  ...
  const { user, loading, error } = useUser(params.username as string);
  ...
  if (error || !user) {
    return <div className="flex justify-center items-center h-64 text-red-600">{error || "User not found"}</div>;
  }
